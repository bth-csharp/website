...
2. Läs och jobba igenom "[Python till C#](/website/laromaterial/kmom01/pythonTillCsharp/)". Testa gärna i [C# online kompilator](https://dotnetfiddle.net/) (glöm ej att välja senaste kompilatorn i menyn till vänster). Skriv din kodsnutt inuti Main()-metoden.

3. Läs och jobba igenom "[Mer C#](/website/laromaterial/kmom01/merCsharp)". Testa gärna i [C# online kompilator](https://dotnetfiddle.net/) (glöm ej att välja senaste kompilatorn i menyn till vänster). Skriv din kodsnutt inuti Main()-metoden.
