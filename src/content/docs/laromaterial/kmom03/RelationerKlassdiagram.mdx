...
<Figure
    src={allRelations}
    caption="Bilden visar symboler för aggregation, komposition och association."
    width="500px"
/>
...
<Figure
    src={classdiagramBankWithRelations}
    caption="Bilden visar banken med dess relationer och kardinalitet."
/>
