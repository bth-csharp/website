...
Du kan ha en bärbar eller stationär, välj efter eget tycke. Kanske en av varje? Är du på campus är det bra att ha en av varje, men även som student på distans kan det vara bra att ha sin labbmiljö på flera datorer.
...
SSD-disk eller liknande är bra för hyfsat snabb dator. Vill du spara mycket data så vill du även ha en traditionell mekanisk hårddisk som ger dig extra utrymme, eller skaffa dig en bärbar USB-disk att ha som extra lagring. Se till tt du kan kopiera data mellan dina hårddiskar och på så sätt få en enkel backup.
