...
Om du kör Windows, se då till att göra det som en användare som har Administratörsrättigheter. Subsystem for Linux (WSL) används för att få tillgång till en Linux‑miljö direkt i Windows, inklusive en terminal där vi kör shell‑programmet Bash.

När lärarteamet väljer Linux-datorer så är det numer ofta Ubuntu. Men är du en van Linuxanvändare så kan du välja fritt bland distributionerna men var medveten om att instruktioner som skrivs är testade på Ubuntu. Alla Linux-system har naturligtvis en terminal och ofta är det shell-programmet Bash.
