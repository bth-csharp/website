...
När du startar upp Visual Studio Code för första gången får du en trevlig välkomstskärm.

import code1 from '@assets/labbmiljo/vscode/code1.png';
...
import code2 from '@assets/labbmiljo/vscode/code2.png';
...
import code3 from '@assets/labbmiljo/vscode/code3.png';
