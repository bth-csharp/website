...
import towerOfHanoi from '@assets/img/kmom06/towerOfHanoi.png';


<Figure
    src={towerOfHanoi}
    caption="Hanois torn med 3 skivor."
    width="350px"
    float="right"
/>
...
<YouTube
    id="https://youtu.be/ShRHZKpYe4w?si=5FhmFfcBZko5vHrq"
    title="Videon visar en rekursiv lösning i Python till mattepusslet Hanois torn."
/>
