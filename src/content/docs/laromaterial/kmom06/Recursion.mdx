...
Den rekursiva metoden anropar sig själv med en modifierad parameter tills den kommer till ett basfall, ett villkor som stoppar rekursionen.
...
- passar för att traversera trädstrukturer.
