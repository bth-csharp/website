...
2. Design, Analysera och försök förstå kraven, gör riktlinjer, bestäm arbetssätt, välj språk som C#, välj systemarkitekturen på programmet, här görs flödesscheman
...
Scrum organiserar arbetet i korta arbetscykler, sprints som är 2-3 veckor långa. I slutet av varje sprint ska teamet ha något att leverera. För att underlätta för teamet eller arbetsgruppen att jobba ihop erbjuder Scrum ett arbetssätt med roller och värderingar och arbetsmetodik. Dagliga statusmöten rekommenderas för att informera alla om status, eventuella problem samt dagens aktiviteter.

I slutet av varje sprint presenteras leveransen med kod, testfall och dokumentation. Teamet får då feedback från beställaren som kan beaktas till nästa sprint. Missförstånd mellan utvecklare och beställare (kund) hittas på så sätt tidigt. Efter sprinten har teamet retrospekt, en återblick där det diskuteras vad som var bra och mindre bra i sprinten. Viktigt med retrospekt är att reflektera över sitt arbete och förbättra sig.
...
Hur tar vi då fram bra tasks? Jo, genom att utgå från ett mål, en uppgift eller ett krav. Är kravet lite större så delar vi upp den i flera tasks. Det är bra om en task har en titel, en beskrivning och att den tar max 1-2 dagar. Om vi tar exemplet med vår bank. Så kan skapa klassen **BankAccount** vara en task men så ska den testas också. Därför är det bra om det blir två tasks; en för att skapa klassen och en för att testa klassen. Försök att göra tasks som är så oberoende som möjligt.
