...
Vi lägger till en ny metod `PrintAsciiModel` i klassen **Car** som använder en metod i klassen **AsciiArt** för hämtar en bild av en biltyp. I det här fallet blir relationen av den svagare typen *associations* som representeras med en pil från klassen som använder den, dvs i det här fallet från **Car** mot **AsciiArt**.
