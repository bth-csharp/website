...
Vi börjar med att skapa basklassen **Car** och funderar på vad som är gemensamt. Det är egenskaperna antalet hjul, bilräknaren, modellen, priset och position. Skapa filen till klassen **Car** i src-katalogen.
