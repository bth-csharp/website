...
Om vi vill skapa ett eget bilobjekt så utgår vi från en ritning som specificerar de sakerna som vi beskrev att en bil består av. Om vi bara har en ritning så har vi inte några bilar, då har vi bara definierat vad som ska ingå i en bil. Det är först när vi bygger bilen som vi skapar ett objekt och den bland annat. får ett nummer till nummerplåten, ett värde på hur långt den har kört, ett modellnummer, en motor och funktionaliteten att röra sig framåt och bakåt och så vidare.
