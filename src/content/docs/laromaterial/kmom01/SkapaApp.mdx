...
![Filstruktur för FirstApp](./../../../images/kmom01/fileStructure.png "Filstruktur för FirstApp")  
*Filstruktur för FirstApp.*
...
![Terminalen efter if-satsen i FirstApp](./../../../images/kmom01/titleWindow.png "Terminalen efter if-satsen i FirstApp")  
*Terminalen efter if-satsen i FirstApp.*
...
![VS code start debug](./../../../images/kmom01/debug_start.png "VS code start debug")  
*VS code start debug.*
