...
![Flödesschema för MenuApp](./../../../images/kmom01/kmom01_4.drawio.png "Flödesschema för MenuApp")
...
![Pseudokod för MenuApp](./../../../images/kmom01/kmom01_4_psuedo.png "Pseudokod för MenuApp")

Pseudokoden i denna bild finns att kopiera längre fram i artikeln.

## Skapa meny-app

Vi börjar med att skapa vår meny-app i terminalen. Vi ställer oss i kmom01, skapar appens katalog och går ner i den. Därefter skapar vi appen. Nedan visas också kommandot för att köra appen.

```shell
pwd // stå i kmom01 i terminalen
...
```csharp
// Pseudokod för kmom01/MenuApp/Program.cs
// Methods
...
![Skriv ut menyn och avsluta MenuApp](./../../../images/kmom01/kmom01_4_menu.png "Skriv ut menyn och avsluta MenuApp")
...
För att förbereda för ett kort huvudprogram, gör vi en metod av allt under kommentaren "// Setup".
