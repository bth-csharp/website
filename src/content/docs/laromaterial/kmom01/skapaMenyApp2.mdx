...
<<<<<<< HEAD:src/content/docs/laromaterial/kmom01/skapaMenyApp.mdx
```bash title='Skapa och kör program med dotnet i katalogen "kmom01/practice"'
=======
```shell title='Skapa och kör program med dotnet i katalogen "kmom01/practice"'
>>>>>>> 46a8e2d (Add debug windows to kmom01):src/content/docs/laromaterial/kmom01/skapaMenyApp2.mdx
...
<<<<<<< HEAD:src/content/docs/laromaterial/kmom01/skapaMenyApp.mdx
```csharp title = "Metod för skriva ut menyn i kmom01/practice/MenuApp/Program.cs"
=======
...
<<<<<<< HEAD:src/content/docs/laromaterial/kmom01/skapaMenyApp.mdx
```csharp title = "Lägg kod för att köra menyn sist i kmom01/practice/MenuApp/Program.cs"
=======
...
=======
```csharp title = "Lägg till switch-satsen i kmom01/practice/MenuApp/Program.cs"
>>>>>>> 46a8e2d (Add debug windows to kmom01):src/content/docs/laromaterial/kmom01/skapaMenyApp2.mdx
    ... 
...
=======
```csharp title = "Lägg till detta i kmom01/practice/MenuApp/Program.cs"
>>>>>>> 46a8e2d (Add debug windows to kmom01):src/content/docs/laromaterial/kmom01/skapaMenyApp2.mdx
// Methods
...
...
<<<<<<< HEAD:src/content/docs/laromaterial/kmom01/skapaMenyApp.mdx
```csharp title = "Lägg till dessa metoden Run och anropa den i kmom01/practice/MenuApp/Program.cs"
=======
