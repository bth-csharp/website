...
Hur kan vi göra en bra meny? Hur börjar vi med uppgiften? Kanske med problemlösning i form av en bild, ett flödesschema? Ett flödesschema är ett bra sätt att komma igång med problemlösningen. Ett annat sätt är att skriva pseudokod i form av kommentarer i en fil.

## Flödesschema

Flödesscheman kan se ut på olika sätt men det brukar vara vanlig kod i rektanglar och romberna som genom anslutande linjer visar flöden med olika vägar i programmet. Romberna kan visa val (if-sats) och iteration (while-loop eller for-loop). Ibland används en rektangel med en halv romb på ena sidan för iteration.  
Det viktigaste är att det går att förstå vad som händer i problemlösningen.
