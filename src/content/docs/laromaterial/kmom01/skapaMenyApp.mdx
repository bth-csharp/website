...
```shell
pwd // stå i kmom01/practice i terminalen
...
```csharp
// Pseudokod för kmom01/practice/MenuApp/Program.cs
// Methods
...
```csharp
// i kmom01/practice/MenuApp/Program.cs
// Methods
