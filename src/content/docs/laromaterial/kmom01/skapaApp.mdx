...
Vi ställer oss i `kmom01/practice` och  med **dotnet** skapar vi vårt första terminalprogram som vi kallar *FirstApp*. Det tar en liten stund. Katalogen *FirstApp* kallas C#-projekt eller applikation.

```bash
pwd // stå i kmom01/practice (terminalen)
...
```csharp
// i kmom01/practice/FirstApp/Program.cs
// Create random class
