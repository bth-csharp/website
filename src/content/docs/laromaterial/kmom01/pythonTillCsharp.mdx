...
**Notera** att konstanter i de flesta andra programmeringspråk består av enbart stora bokstäver med understreck mellan orden så vi använder det här också, även om C# rekommenderar Pascal case.
