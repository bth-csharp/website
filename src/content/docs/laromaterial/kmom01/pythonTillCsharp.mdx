...
```python title="Kommentarer i Python"
# first_name = "Murphy" En rad
'''
age = 42
Flera rader
'''
...
**Notera** att konstanter i de flesta andra programmeringsspråk består av enbart stora bokstäver med understreck mellan orden så vi använder det här också, även om C# rekommenderar Pascal case.
...
En array är en referensdatatyp med fast storlek och en bestämd datatyp.
...
Listor är en referensdatatyp och finns både i Python och C#. I Python kan vi spara element av olika datatyper i listor. I C# behöver vi deklarera vilken datatyp listan ska bestå av. Gemensamt är att vi kan ändra på listan genom att lägga till och ta bort element i listan. Vi kan även uppdatera element i listan.
...
```csharp title="Lista med modern deklaration i C#"
using System.Collections.Generic; // För att använda listor 
