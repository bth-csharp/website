...
| TestGetBankAccounts-ForOwnerNegative | Skapa en bank med namn. Lägg till 3 konton varav 2 med samma ägare. Mocka kontona. | En instans skapas. Verifiera att en lista som returneras är tom då vi anropar GetBankAccounts med en ägare som inte finns i listan. | Ok/inte ok | Krav 5 |
