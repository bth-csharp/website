...
Du har fått med `.editorconfig` från ett template repo `csharp-abcd25` som passar denna kursen.
...
Öppna gärna filen `editorconfig` i VS Code och titta snabbt igenom reglerna för C#.
