...
description: Lägg till ssh-nycklar för att autentisera din användare mot GitHub.
author: mos
revision:
...
:::note
På bilderna i denna artikel står det `webtec` som kursnamn. Ignorera det och låtsas som att det står `csharp`, vilket det ska göra för er.
:::

Så här skapar du ssh-nycklar lokalt i din terminal och lägger till dem i ditt konto på GitHub så att du kan autentisera dig mot GitHub som rätt användare.

:::caution
Om du redan har skapat ssh-nycklar på denna datorn och lagt till din användare på GitHub ska du hoppa över denna artikeln och gå vidare till nästa.
...
Du kan öppna din publika nyckel i VS Code på följande sätt.

```console title="Hur du kan öppna den publika nyckeln i VS Code."
...
<details>
<summary>Om ssh-nycklar saknas - skapa nya</summary>
