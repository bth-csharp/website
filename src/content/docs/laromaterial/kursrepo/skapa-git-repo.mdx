...
### Kolla ditt Git repos brancher 

Nu kan du köra följande kommandon för att kolla vilka brancher som finns i ditt kursrepo.

```bash title="Kommandon för att kolla brancher i ditt kursrepo"
cd csharp-<akronym>
git branch -r
```
**OBS** Fixa här
...
git remote add origin git@github.com:bth-csharp/$REPO.git
