...
Det första du behöver göra är att berätta vilket namn du har på repot. Detta är samma namn som du använde när du skapade platsen för repot på GitHub. I exemplet användes `csharp-abcd25` som namn.

Kör följande kommando (men byt ut `csharp-abcd25` mot namnet på ditt repo).
