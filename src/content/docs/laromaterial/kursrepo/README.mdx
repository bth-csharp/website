...
Det finns ett [repo `csharp-abcd25`](https://github.com/bth-csharp/csharp-abcd25) som används i guiden och det är skapat enligt guiden och det innnehåller också övrig utvecklingsmiljö som studenten sätter upp under kursens gång. Detta repo innehåller också samtliga utvecklingsverktyg som behövs innan man kan sätta igång med kmom01.
...
git clone --mirror git@github.com:bth-csharp/csharp-abcd25.git $REPO
cd $REPO
```
...
git remote set-url origin git@github.com:bth-csharp/$REPO.git
git push --mirror
```

Nu är det klart och du kan börja jobba med ditt repo.

Här är direktlänken till det exempelrepo som är skapat som en mirror, [`csharp-mirror`](https://github.com/bth-csharp/csharp-mirror).
...
Här är en direktlänk till hur du [skapar en fork av exempelrepot `csharp-abcd25`](https://github.com/bth-csharp/csharp-abcd25/fork).
...
Här är direktlänken till det exempelrepo som är forkat, [`csharp-fork`](https://github.com/bth-csharp/csharp-fork).
