...
Om läraren tycker att allt ser bra ut får du en kommentar, label Approved och G i Canvas. Läraren mergar din PR och stänger den. Du kan jobba vidare med nästa kmom.
...
- Om din fix funkade ska du nu få `submitted` och `tests-passed`.
