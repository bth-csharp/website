...
Skapa en klass som hanterar B&B:et. Dbwebb B&B har ett bestämt antal övernattningsmöjligheter som beskrivs med ett rumsnummer, antal gäster och om frukost önskas. Informationen om de olika övernattningsmöjligheterna läser du in från fil. Här behöver du fundera över hur informationen om rummen ska lagras på filen så att du kan anpassa läsningen efter det. Informationen om övernattningsmöjligheterna hittar du ovan. 
...
Menyalternativ 3 möjliggör borttagning av en gäst. Skriv ut alla gäster i gästlistan först för att se gästens id-nummer och använda det för att ta bort gästen.
...
Implementera testfallen med NUnit som du gjorde i kmom05.  
Tänk 1-2 testfall per publik metod i varje klass. En testklass per klass. Gör ett testprojekt som du gjorde i kmom05.

### Krav 5: Betalning & paketlösningar (Optionellt)

Dbwebb B&B vill börja med uthyrning av cyklar och kanoter. De bokas med pris per timme och en gäst från gästlistan är ansvarig.

Olika paket:

- Övernattning rum med badrum+cykel (cykel på köpet)
- Äventyrspaketet med stuga+frukost+kanot (50% rabatt på kanoten & städning ingår)

Olika paketlösningar ger billigare totalpris. Paketlösningar ska vara en abstrakt klass med abstrakta metoder eller ett interface. 

Vad kostar de olika paketen? Är det lönsamt med paketen?
