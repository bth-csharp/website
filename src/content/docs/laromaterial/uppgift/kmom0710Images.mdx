...
Du ska använda ett interface och implementationen ska innehålla minst 2 klasser utöver interfacet. Interfacet ska innehålla minst 4 metoder för hämta namn (t ex "Cykeluthyrning"), hämta inkomst, hämta kostnad och hämta vinst. I menyalternativ 7 anger du antalet dagar som rapporten ska beräknas på.
...
Utöka bokningen med datum och betalning. Nu ska du kunna ge ett startdatum och ett antal nätter eller start- och slutdatum när du söker efter lediga övernattningsmöjligheter för ett visst antal gäster 1-4. Även bokningen ska utökas med startdatum och ett antal nätter eller start- och slutdatum.
