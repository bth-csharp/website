...
Arbeta i `main` -branchen och gör många och små commits i ditt lokala Git-repo, du kan ha ungefär 6-10 commits för en sådan här uppgift. Och pusha till ditt GitHub repo.
