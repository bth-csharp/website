...
Du har jobbat igenom materialet i "[kmom01](/website/kmom/kmom01)".
...
Fråga efter en temperatur i Celsius (ska kunna vara ett tal med decimaler) och returnera motsvarande temperatur i Fahrenheit avrundat till 2 decimaler. Inmatningen av temperaturen i Celsius ska ske innan anrop av metoden `ConvertCelsiusToFahrenheit`.  Använd den inbyggda metoden **Round** för avrundning.  
Inmatning sker innan metoden anropas. Utskriften sker efter anropet.  
Exempel:
...
Fråga efter en sträng och skriva ut en ny sträng där varje tecken har ökat med +1 och är separerat med "-".  
Inmatning sker i metoden. Utskriften sker efter anropet.  
Exempel:
...
Fråga efter en sträng och skapa en akronym genom att plocka ut alla stora bokstäver i namnet du skriver in.  
Inmatning sker i metoden. Utskriften sker efter anropet.  
Exempel:
...
Låt användaren mata in tal tills texten "klar" matas in. Då skriv summan av talen och medelvärdet av talen ut. Metoden returnerar en sträng med summan och medelvärdet enligt output nedan. Avrunda medelvärdet till 2 decimaler först vid utskriften i en interpolerande sträng genom formatering.  
Inmatning sker i metoden. Utskriften sker efter anropet.  
Exempel:
...
Glöm inte att använda 'dotnet format' för att formatera din kod. Se i slutet av [Skapa terminalprogram](/website/laromaterial/kmom01/skapaapp) för mer information om 'dotnet format'.
