...
I denna uppgiften får du möjlighet att använda en statisk klass **AsciiArt**  som "skriver ut" tärningarna som enkla terminalbilder i [ASCII](https://sv.wikipedia.org/wiki/ASCII). Du uppdaterar klassen **Die** med en ny metod för detta. Syftet med denna del är att visa att klassen **Die** kan använda andra klasser.
...
Projektet som du skapar ska heta **Dice100** och det skapar du i kmom03. Kopiera in de klasser du redan har från kmom02 och lägg dem under kmom03/Dice100/src.
...
Lägg alla klasser i en egen fil! All in- och utmatning i klassen **Menu**!

1. Lägg till en ny metod i klassen **Die** som heter `PrintAsciiArt`. Metoden använder klassen **AsciiArt** och dess metod `PrintDie`.

2. Uppdatera klassen **Round** att använda den nya metoden `PrintAsciiArt` istället för.

3. Gör det möjligt att mata in antalet tärningar som spelet ska använda. Inmatning ska ske via terminalen och all in- och utmatning ska ske i klassen **Menu**.
...
9. Skriv 3-5 rader om hur du hade delat upp klasser och objekt och dess relationer och du inte fått kraven från kmom02 och kmom03. Dice100 ska ha samma funktionalitet som i kmom03.
