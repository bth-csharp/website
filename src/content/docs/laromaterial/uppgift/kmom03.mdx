...
Klassen **AsciiArt** innehåller bilder på tärningarna som kan användas för att göra det lite roligare i terminalen. Ladda ner klassen **AsciiArt** och lägg den i katalogen "kmom03/Dice100/src". Uppdatera namespace till **MenuApp2.src**.
