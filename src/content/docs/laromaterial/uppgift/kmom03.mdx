...
9. Skriv 3-5 rader om hur du hade delat upp klasser och objekt och dess relationer om du hade fått bestämma själv. Dice100 ska ha minst samma funktionalitet som i kmom03. Tips på tankar: Om du lägger till en klass som hanterar tärningar, ska tärningen själv ha sin bild, ska Game äga Menu (anpassning till olika språk), annan funktionalitet, ska det finnas en klass Spelare etc.
Skriv meningarna i Canvasinlämningen.
