...
- **Die()** en publik konstruktor som instansierar ett Die-objekt, tilldela det privata attributet `_value` ett slumptal mellan `MIN_VALUE` och `MAX_VALUE`.
...
- **Round()** en publik konstruktor som instansierar ett Round-objekt och initierar instansvariablerna. Poängen bör sättas till 0 och en lista med tärningsobjekt bör skapas. Listan ska vara lika lång som antalet tärningar i rundan.
