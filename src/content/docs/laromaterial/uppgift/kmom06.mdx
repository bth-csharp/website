...
:::note
Det är samma video som i kmom05 eftersom det enda som är ändrat är rubriken på terminalfönstret som är ändrat till **MyPlanner2**.
:::

<YouTube
    id="SwcDdAU_--U"
    title="Så här kan MyPlanner2 se ut. Den ser likadan ut som MyPlanner"
/>
...
När du gör en PR så körs först dina tester på din kod och sen lärartester på kmom05 och kmom06. Där tester vi enligt krav och klassdiagram samt följer koden (Planner och MyTaskHandler) ni laddade ner.

<details>
<summary>Kolla här om du behöver hjälp att få testerna att passera för din PR för kmom06</summary>

Kolla i slutet av PRn och där är det information om:
- Studenttester (dina)
- Lärartester för kmom05 & kmom06, tabell med testresultat om din kod kompilerar med testerna och om den saknas så kompilerar inte din kod med testerna.
...
Testerna följer kraven och koden du laddade ner för klassen Planner och MyTaskHandler. Exempel på ett fel: 
