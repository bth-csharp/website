...
:::note
Det är samma video som i kmom05 eftesom det enda som är ändrat är rubriken på terminalfönstret som är ändrat till **MyPlanner2**.
:::

<YouTube
    id="SwcDdAU_--U"
    title="Så här kan MyPlanner2 se ut. Den är likadan som MyPlanner"
/>
