---
title: "Lärarstöd och handledning" 
...
Det är aldrig fel att fråga och alla frågor förtjänar ett svar.
...
<YouTube
    id="eUBMCd7Tj6Q" 
    caption="Mikael visar vikten av att ha en gummianka på skrivbordet."
/>
...
Tänk att chatter (IRC, Gitter, Discord) är snabba och om du inte får ett svar så kommer din fråga troligen att försvinna i flödet av andras chattande.

Då tar du och kopierar din fråga till forumet (GitHub issues) och inväntar svar.

Det är lättare att få långa och utredande svar på forum. I chatter blir det ofta korta svar.

I forum kan du ställa kompletterande frågor eller be om förtydligande.



Öppna chatter, eller personliga
------------------------------------------

Använd de öppna publika chatterna.

Du kommer troligen få svar även om du skickar personliga chatter till en lärare. Men du missar möjligheten att få svar av dina medstudenter och du missar möjligheten att bidra till den öppna communityn.

Om dina frågor blir många, eller felsökningen blir svår, då kan det vara lämpligt att gå över till en privat chatt för att undvika att man bombarderar den publika chatten. Men, börja alltid i den publika chatten.
...
> [mos] Man brukar kunna googla "bth läsårsindelning", https://www.bth.se/student/lasar-och-terminstider. Säger 7/6.
